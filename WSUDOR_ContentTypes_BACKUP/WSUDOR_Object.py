...
class WSUDOR_Object:
	...
	# init
	def __init__(self,objType=False,payload=False):		
		...
		if objType == "WSUDOR":
			...
			# IMPROVEMENT - CHECK if 'payload' eulfedora object or simply pid (currently eulfedora object)
		...
		# Retrieve attributes and methods from ContentType sub-class
