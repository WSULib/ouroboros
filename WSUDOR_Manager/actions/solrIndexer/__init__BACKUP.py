...
def solrIndexer(fedEvent, PID):	
	...
	def getLastFedoraIndexDate():		
		...
		query_params = {
			"q":"id:LastFedoraIndex",
			"fl":"last_modified"
		}
		results = solr_handle.search(**query_params)
		if len(results.documents) > 0:
			LastFedoraIndexDate = results.documents[0]['last_modified']
			print "Last index date:",LastFedoraIndexDate
	...
	def getToUpdate(LastFedoraIndexDate):
		...
		# returns some kind of generator
