...
solr_handle = Solr('http://%s/solr4/%s' % (localConfig.SOLR_HOST, localConfig.SOLR_SEARCH_CORE), version=4)
# single, primary management core
solr_manage_handle = Solr('http://%s/solr4/%s' % (localConfig.SOLR_HOST, localConfig.SOLR_MANAGE_CORE), version=4)
