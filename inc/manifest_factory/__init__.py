...
iiif_manifest_factory_instance.set_base_metadata_uri("https://%s/iiif_manifest" % localConfig.IIIF_MANIFEST_TARGET_HOST)
# Where the resources live on disk
iiif_manifest_factory_instance.set_base_metadata_dir("/tmp")

# Default Image API information
iiif_manifest_factory_instance.set_base_image_uri("https://%s/loris" % localConfig.IIIF_MANIFEST_TARGET_HOST)
