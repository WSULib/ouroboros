...
class BagClass(object):
    ...
    def __init__(self, object_row, ObjMeta, bag_root_dir, files_location, purge_bags):
        ...
        # hardcoded
        self.name = 'Audio'  # human readable name, ideally matching filename, for this bag creating class
        self.content_type = 'WSUDOR_Audio'  # not required, but easy place to set the WSUDOR_ContentType
